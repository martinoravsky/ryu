					...
					if opt.kind == 30:
						...
						if subtype == "00":
							...
							if ht.bits == 2:
								...
								query = "replace INTO mptcp.conn (ip_src,ip_dst,keya,tokena,tcp_src,tcp_dst) values('{tsrc}','{tdst}','{keya}',{tokena},{htsrc_port},{htdst_port});"
							...
							# MP_CAPABLE ACK
								...
								connpaths = nx.all_shortest_paths(self.net,src,dst)
								for p in connpaths:
						...
						# MP_JOIN
							...
							if ht.bits == 2:
								...
								print connpaths	
								print "vypisal som connpaths"
								for p in connpaths:
									print ("Connpaths v mpjoin: ", p)
